...
map("n", "<leader>nn", vim.cmd.ObsidianNew, { desc = "New Note" })
map("n", "<leader>ns", vim.cmd.ObsidianQuickSwitch, { desc = "Quick Swicth" })
map("n", "<leader>nf", vim.cmd.ObsidianFollowLink, { desc = "Follow Link" })
...
map("n", "<leader>nx", vim.cmd.ObsidianExtractNote, { desc = "Extract Note" })
map("n", "<leader>nw", vim.cmd.ObsidianWorkspace, { desc = "Workspace" })
map("n", "<leader>np", vim.cmd.ObsidianPasteImg, { desc = "Paste Image" })
map("n", "<leader>nr", vim.cmd.ObsidianRename, { desc = "Rename Note" })
