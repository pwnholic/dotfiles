...
function M.keys()
	...
	return {
		...
		{ "<localleader>1", select(1), desc = "Mark File 1" },
		{ "<localleader>2", select(2), desc = "Mark File 2" },
		{ "<localleader>3", select(3), desc = "Mark File 3" },
		{ "<localleader>4", select(4), desc = "Mark File 4" },
		{ "<localleader>5", select(5), desc = "Mark File 6" },
		{ "<localleader>6", select(6), desc = "Mark File 6" },
		{ "<localleader>7", select(7), desc = "Mark File 7" },
		{ "<localleader>8", select(8), desc = "Mark File 8" },
		{ "<localleader>9", select(9), desc = "Mark File 9" },
