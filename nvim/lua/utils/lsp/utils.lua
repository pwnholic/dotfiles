...
function M.build_nested(key_parts, val)
	return key_parts[1] and { [key_parts[1]] = M.build_nested({ table.unpack(key_parts, 2) }, val) } or val
end
...
function M.lsp_soft_stop(client_or_id, opts)
