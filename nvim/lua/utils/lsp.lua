...
function M.keys_on_attach(_, buffer)
	...
	local keymaps = Keys.resolve({
        -- stylua: ignore start
		{ "<leader>gr", "<cmd>FzfLua lsp_references<cr>", desc = "References", has = methods.textDocument_references },
		{ "gd", "<cmd>FzfLua lsp_definitions<cr>", desc = "Definition", has = methods.textDocument_definition },
		{ "<leader>gd", "<cmd>FzfLua lsp_declarations<cr>", desc = "Declaration", has = methods.textDocument_declaration },
		{ "gD ", "<cmd>FzfLua lsp_typedefs<cr>", desc = "Type Definition", has = methods.textDocument_typeDefinition },
		{ "<leader>gi", "<cmd>FzfLua lsp_implementations<cr>", desc = "Implementation", has = methods.textDocument_implementation },
		...
		{ "<leader>gi", "<cmd>FzfLua lsp_incoming_calls<cr>", desc = "Incoming Calls", has = methods.callHierarchy_incomingCalls },
		{ "<leader>go", "<cmd>FzfLua lsp_outgoing_calls<cr>", desc = "Outgoing Calls", has = methods.callHierarchy_outgoingCalls },
