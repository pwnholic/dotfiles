return {
	setup = function()
		...
		map("x", "@", function() return ":norm @" .. vim.fn.getcharstr() .. "<cr>" end, { expr = true, silent = true })
		...
		map( "x", "cq", [[":\<C-u>call v:lua.SetupMultipleCursors()<CR>gv" . g:mc . "``qz"]], { expr = true, desc = "Inititiate with macros" })
