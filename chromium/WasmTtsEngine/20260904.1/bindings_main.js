...
(function() {
  ...
  var hasProcess = typeof process !== "undefined" && process;
  if (hasProcess && !(process.versions && process.versions.bun) && typeof Deno == "undefined") {
    var isNode = process.versions && process.versions.node;
...
var PThread = {
  ...
  allocateUnusedWorker() {
    ...
    if (globalThis.trustedTypes?.createPolicy) {
      PThread.trustedWorkerPolicy ??= trustedTypes.createPolicy("emscripten#workerPolicy", {
        createScriptURL: url => url
      });
      worker = new Worker(PThread.trustedWorkerPolicy.createScriptURL(pthreadMainJs), {
...
function assignWasmExports(wasmExports) {
  ...
  _GoogleTtsInit = Module["_GoogleTtsInit"] = createExportWrapper("GoogleTtsInit", wasmExports["GoogleTtsInit"], 2);
  _GoogleTtsShutdown = Module["_GoogleTtsShutdown"] = createExportWrapper("GoogleTtsShutdown", wasmExports["GoogleTtsShutdown"], 0);
  _GoogleTtsInstallVoice = Module["_GoogleTtsInstallVoice"] = createExportWrapper("GoogleTtsInstallVoice", wasmExports["GoogleTtsInstallVoice"], 3);
  _GoogleTtsInitBuffered = Module["_GoogleTtsInitBuffered"] = createExportWrapper("GoogleTtsInitBuffered", wasmExports["GoogleTtsInitBuffered"], 4);
  _GoogleTtsReadBuffered = Module["_GoogleTtsReadBuffered"] = createExportWrapper("GoogleTtsReadBuffered", wasmExports["GoogleTtsReadBuffered"], 0);
  _GoogleTtsFinalizeBuffered = Module["_GoogleTtsFinalizeBuffered"] = createExportWrapper("GoogleTtsFinalizeBuffered", wasmExports["GoogleTtsFinalizeBuffered"], 0);
  _GoogleTtsGetTimepointsCount = Module["_GoogleTtsGetTimepointsCount"] = createExportWrapper("GoogleTtsGetTimepointsCount", wasmExports["GoogleTtsGetTimepointsCount"], 0);
  _GoogleTtsGetTimepointsTimeInSecsAtIndex = Module["_GoogleTtsGetTimepointsTimeInSecsAtIndex"] = createExportWrapper("GoogleTtsGetTimepointsTimeInSecsAtIndex", wasmExports["GoogleTtsGetTimepointsTimeInSecsAtIndex"], 1);
  _GoogleTtsGetTimepointsCharIndexAtIndex = Module["_GoogleTtsGetTimepointsCharIndexAtIndex"] = createExportWrapper("GoogleTtsGetTimepointsCharIndexAtIndex", wasmExports["GoogleTtsGetTimepointsCharIndexAtIndex"], 1);
  _GoogleTtsGetTimepointsCharLengthAtIndex = Module["_GoogleTtsGetTimepointsCharLengthAtIndex"] = createExportWrapper("GoogleTtsGetTimepointsCharLengthAtIndex", wasmExports["GoogleTtsGetTimepointsCharLengthAtIndex"], 1);
  _GoogleTtsGetEventBufferPtr = Module["_GoogleTtsGetEventBufferPtr"] = createExportWrapper("GoogleTtsGetEventBufferPtr", wasmExports["GoogleTtsGetEventBufferPtr"], 0);
  _GoogleTtsGetEventBufferLen = Module["_GoogleTtsGetEventBufferLen"] = createExportWrapper("GoogleTtsGetEventBufferLen", wasmExports["GoogleTtsGetEventBufferLen"], 0);
  ...
  dynCall_iiiijij = createExportWrapper("dynCall_iiiijij", wasmExports["dynCall_iiiijij"], 9);
  dynCall_jiji = createExportWrapper("dynCall_jiji", wasmExports["dynCall_jiji"], 5);
  dynCall_vijj = createExportWrapper("dynCall_vijj", wasmExports["dynCall_vijj"], 6);
  dynCall_ji = createExportWrapper("dynCall_ji", wasmExports["dynCall_ji"], 2);
  dynCall_jij = createExportWrapper("dynCall_jij", wasmExports["dynCall_jij"], 4);
  dynCall_viiiijii = createExportWrapper("dynCall_viiiijii", wasmExports["dynCall_viiiijii"], 9);
  dynCall_jiiii = createExportWrapper("dynCall_jiiii", wasmExports["dynCall_jiiii"], 5);
  dynCall_jiii = createExportWrapper("dynCall_jiii", wasmExports["dynCall_jiii"], 4);
  dynCall_viij = createExportWrapper("dynCall_viij", wasmExports["dynCall_viij"], 5);
  dynCall_viijii = createExportWrapper("dynCall_viijii", wasmExports["dynCall_viijii"], 7);
  dynCall_jii = createExportWrapper("dynCall_jii", wasmExports["dynCall_jii"], 3);
  dynCall_jiij = createExportWrapper("dynCall_jiij", wasmExports["dynCall_jiij"], 5);
  dynCall_vij = createExportWrapper("dynCall_vij", wasmExports["dynCall_vij"], 4);
  dynCall_iij = createExportWrapper("dynCall_iij", wasmExports["dynCall_iij"], 4);
  dynCall_jjj = createExportWrapper("dynCall_jjj", wasmExports["dynCall_jjj"], 5);
  dynCall_iiiijj = createExportWrapper("dynCall_iiiijj", wasmExports["dynCall_iiiijj"], 8);
  dynCall_viijj = createExportWrapper("dynCall_viijj", wasmExports["dynCall_viijj"], 7);
  dynCall_viiijjj = createExportWrapper("dynCall_viiijjj", wasmExports["dynCall_viiijjj"], 10);
  dynCall_iiij = createExportWrapper("dynCall_iiij", wasmExports["dynCall_iiij"], 5);
  dynCall_jiijj = createExportWrapper("dynCall_jiijj", wasmExports["dynCall_jiijj"], 7);
  dynCall_viji = createExportWrapper("dynCall_viji", wasmExports["dynCall_viji"], 5);
  dynCall_iiji = createExportWrapper("dynCall_iiji", wasmExports["dynCall_iiji"], 5);
  dynCall_iijjiii = createExportWrapper("dynCall_iijjiii", wasmExports["dynCall_iijjiii"], 9);
  dynCall_vijjjii = createExportWrapper("dynCall_vijjjii", wasmExports["dynCall_vijjjii"], 10);
  dynCall_vijjj = createExportWrapper("dynCall_vijjj", wasmExports["dynCall_vijjj"], 8);
  dynCall_vj = createExportWrapper("dynCall_vj", wasmExports["dynCall_vj"], 3);
  dynCall_iijjiiiii = createExportWrapper("dynCall_iijjiiiii", wasmExports["dynCall_iijjiiiii"], 11);
  dynCall_iiiiij = createExportWrapper("dynCall_iiiiij", wasmExports["dynCall_iiiiij"], 7);
  dynCall_iiiiijj = createExportWrapper("dynCall_iiiiijj", wasmExports["dynCall_iiiiijj"], 9);
  dynCall_iiiiiijj = createExportWrapper("dynCall_iiiiiijj", wasmExports["dynCall_iiiiiijj"], 10);
